...
async def run_analytics_agent(db: AsyncSession, user_id: uuid.UUID, user_message: str) -> str:
    """
    ...
    try:
        ...
        return f"Error executing agentic loop: {str(e)}"
        
    return final_text or "No response generated by the agent."
