...
export default function AnalyticsPage() {
    ...
    const handleExportJson = async () => {
        setExporting(true);
        try {
            const dbData = await api.get("/export/json");
    ...
    const handleConsultCoach = async () => {
        ...
        setCoachError(null);
        try {
            const res = await api.post("/agent/insights", { message: coachQuery });
            setCoachResponse(res.response);
        } catch (err: any) {
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
                            <Card sx={{ p: { xs: 2.5, sm: 4 }, mt: 4, border: "1px solid", borderColor: "divider" }}>
                                ...
                                <Button
                                    ...
                                    size="large"
                                    fullWidth
                                    startIcon={loadingCoach ? <CircularProgress size={20} color="inherit" /> : <CoachIcon />}
                                ...
                                >
                                    {loadingCoach ? "Analyzing Data..." : "Consult AI Coach"}
                                </Button>
