...
const getCustomTheme = (mode: "light" | "dark") => {
    ...
    return createTheme({
        palette: {
            mode,
            primary: {
                main: isDark ? "#8B5CF6" : "#7C3AED", // Violet 500 / 600
                light: isDark ? "#A78BFA" : "#A78BFA",
                dark: isDark ? "#6D28D9" : "#5B21B6",
            },
            secondary: {
                main: isDark ? "#2ECB71" : "#10B981", // Green/Emerald
            ...
            background: {
                default: isDark ? "#0A0915" : "#F9FAFB", // Rich space black-violet / Light grey
                paper: isDark ? "#121124" : "#FFFFFF",   // Premium card background / Pure White
            },
            text: {
...
export default function Providers({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        const updateResolvedTheme = () => {
            ...
            // Apply color-scheme to document to fix browser pickers (calendar/clock) visibility!
